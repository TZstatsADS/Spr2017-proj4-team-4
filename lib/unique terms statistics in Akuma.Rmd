...
setwd("/Users/Bowen/Documents/2017Spring/ADS/Spr2017-proj4-team-4-master/data/nameset")
...
```{r}
AKumar <- data.frame(scan('/Users/Bowen/Documents/2017Spring/ADS/Spr2017-proj4-team-4-master/data/nameset/AKumar.txt',
...
```{r}
source('/Users/Bowen/Documents/2017Spring/ADS/Spr2017-proj4-team-4-master/lib/evaluation_measures.R')
...
```{r}
all_terms<-(vocab$vocab[,1])[[1]]
term_df<-matrix(sort(all_terms),nrow=33)
write.csv(term_df,'unique_terms.csv')
length_vec<-c()
for(i in 1:length(all_terms)){
  length_vec=c(length_vec,nchar(all_terms[i]))
}
table(length_vec)
plot(table(length_vec))
```
